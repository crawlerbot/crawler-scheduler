...
public class CrawlerSchedulerApp {

    private static final Logger log = LoggerFactory.getLogger(CrawlerSchedulerApp.class);

    private final Environment env;

    public CrawlerSchedulerApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes CrawlerScheduler.
     * <p>
    ...
    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(CrawlerSchedulerApp.class);
